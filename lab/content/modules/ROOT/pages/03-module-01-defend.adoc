...
----
+
You should now see events for **both** `rhel01` and `rhel02`.
...
. In AAP Controller, navigate to **Resources → Templates** and launch the **DEFEND - Scan System** job template. When prompted for a **Limit**, enter `rhel02`.
+
...
. Switch to the **AAP Controller** tab and navigate to **Views → Jobs** — the **Vulnerability Containment** workflow should be launching automatically, limited to `rhel02`.

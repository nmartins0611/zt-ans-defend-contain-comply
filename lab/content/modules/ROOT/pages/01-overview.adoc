...
You're a **platform engineer** at **Benekratis Capital**, responsible for the security posture of production RHEL infrastructure. Your team manages customer-facing application servers running `httpd` behind a load balancer.
...
By the end of this workshop, you'll have practical AAP skills to address Benekratis Capital's vulnerability management requirements:
...
== Benekratis Capital's challenges

**The situation**: Benekratis Capital processes 2 million transactions daily. Any customer-facing service outage or compromise has immediate regulatory and reputational impact.

...
* Webhook Endpoint: paste the Event Stream URL from step 3. Please note you need to remove aap.example.org from the URL due to the workshop environment, use 192.168.1.10 instead. EG: https://192.168.1.10:443/eda-event-streams/api/eda/v1/external_event_stream/bf6e8ea1-fb1e-4a54-aae0-d0a7f9f27327/post/
* Auth Type: `API Key`
* Token: ansibleiscool
...
. Navigate to **Automation Execution → Templates**, and edit **Vulnerability Containment** by selecting **Prompt on launch** for **Extra Variables** and save the workflow.

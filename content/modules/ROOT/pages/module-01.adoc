...
image::s01p01.png[Authentication method mapping configuration interface,link=self,window=blank]
...
image::s01p01.png[LDAP authenticator mapping interface showing create mapping option,link=self,window=blank]
...
image::s01p03.png[Mapping details screen showing completed organization member mapping,link=self,window=blank]
...
image::s01p04.png[Organization admin mapping configuration for zta-admins group,link=self,window=blank]


. **Superuser (Group)** — grants superuser flag to `zta-admins`:
...
image::s01p05.png[Team mapping configuration showing Infrastructure team mapping to IdM group,link=self,window=blank]
...
image::s01p06.png[NetBox VLAN configuration showing App-tier Data-tier and Management VLANs,link=self,window=blank]

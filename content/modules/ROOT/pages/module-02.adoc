...
image::s02p01.png[Workflow visualizer showing Check DB policy template as first step,link=self,window=blank]
...
image::s02p02.png[Workflow step configuration showing Create DB Credential linked on success,link=self,window=blank]
...
image::s02p03.png[Complete deployment workflow showing four sequential steps with success links,link=self,window=blank]
...
image::s02p04.png[Team access configuration showing role assignments for workflow template,link=self,window=blank]
...
image::s02p05.png[IdM interface showing user group assignment for neteng user,link=self,window=blank]
...
image::s02p06.png[Workflow job failure showing OPA policy denial for neteng user,link=self,window=blank]

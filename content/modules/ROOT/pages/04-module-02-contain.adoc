...
. First, we need to look at what the policy actually is. Go the *Gitea* tab, navigate to `lab/policies/patch-policy.yml` and read through the Rego policy. 
. The company policy will check for:
+
[Policy checks]
====
. Maintenance Window
...
* OPA Server hostname: `192.168.1.11`
* Click **save**

...
. Associate the policy with the patching workflow:
+
* Find the **Policy-Gated Patching** workflow template
* Attach the **Patch Authorization** policy as an execution gate
+
